...
const OPENING_BOOK = {
    ...
    "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq": {
        ...
        timmy: [{ move: "d4", weight: 100 }] // Timmy always plays 1.d4 as White!
    },
    ...
    "rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq": {
        ...
        timmy: [{ move: "e5", weight: 100 }] // Timmy plays e5 vs e4
    },
    ...
    "rnbqkbnr/pppp1ppp/8/4p3/4P3/5N2/PPPP1PPP/RNBQKB1R b KQkq": {
        ...
        timmy: [{ move: "Nc6", weight: 100 }] // Italian setup
    },

    // 1. e4 e5 2. Nf3 Nc6 -> 3. Bb5 / 3. Bc4 (Italian)
    ...
    "r1bqkbnr/pppp1ppp/2n5/4p3/2B1P3/5N2/PPPP1PPP/RNBQK2R b KQkq": {
        default: [{ move: "Bc5", weight: 70 }, { move: "Nf6", weight: 30 }],
        timmy: [{ move: "Bc5", weight: 100 }] // Giuoco Piano as Black!
    },
    ...
    "rnbqkbnr/ppp1pppp/8/3p4/3P4/8/PPP1PPPP/RNBQKBNR w KQkq": {
        ...
        timmy: [{ move: "c4", weight: 100 }] // Queen's Gambit 100%!
    },
